...
const overrides = {
  ...
  // saying that web3.platon.net.getId is a function and doesn't
  // have a `method` property, which it does
  getId: (web3: Web3Shim) => {
    // @ts-ignore
    const _oldGetIdFormatter = web3.platon.net.getId.method.outputFormatter;
    // @ts-ignore
    web3.platon.net.getId.method.outputFormatter = (networkId: NetworkId) => {
