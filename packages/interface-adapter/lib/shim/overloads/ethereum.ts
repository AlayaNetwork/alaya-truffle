...
const overrides = {
  ...
  getBlock: (web3: Web3Shim) => {
    // @ts-ignore
    const _oldFormatter = web3.platon.getBlock.method.outputFormatter;

    // @ts-ignore
    web3.platon.getBlock.method.outputFormatter = (block: EvmBlockType) => {
      // @ts-ignore
      let result = _oldFormatter.call(web3.platon.getBlock.method, block);
  ...
  getTransaction: (web3: Web3Shim) => {
    ...
    // @ts-ignore
    web3.platon.getTransaction.method.outputFormatter = (tx: EvmTransaction) => {
