...
const execute = {
   ...
   * @param  {Number} blockL   imit  most recent network block.blockLimit
    ...
    return function() {
      ...
      execute
        ...
        .then(async ({ args, params, network }) => {
          ...
          deferred = web3.platon.sendTransaction(params);
    ...
    return function() {
      ...
      execute
        ...
        .then(async ({ args, params, network }) => {
          ...
          const options = {
            //data: constructor.bytecode.slice(2),
            data: constructor.binary,
            arguments: args
          };
          const contract = new web3.platon.Contract(constructor.abi);
	  params.data = contract.deploy(options).encodeABI();
          ...
          try {
            ...
            const web3Instance = new web3.platon.Contract(
              constructor.abi,
  ...
  estimateDeployment: function() {
    ...
    return execute
      ...
      .then(res => {
        ...
        const instance = new constructor.web3.platon.Contract(
          constructor.abi,
          res.params
        );
